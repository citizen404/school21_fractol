...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/07/04 23:53:51 by lconchit          #+#    #+#             */
/*   Updated: 2020/07/13 19:45:44 by lconchit         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				draw_burningship(t_fr *fr)
{
	...
	while (x < WIN_WIDTH)
	{
		...
		while (y < WIN_HEIGHT)
		{
			...
			color = map_fr(check_burningship(fr), fr->n, 0, 255);
